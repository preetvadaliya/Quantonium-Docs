...
| :--------- | :----------------------------- | :------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------ |
| selection  | <span class="text">text</span> | <div block-type = "getter" variable-name = selection id = "param-get-spinner-afterselecting-selection"></div> | <div block-type = "setter" variable-name = selection id = "param-set-spinner-afterselecting-selection"></div> |
...
| Param Name | IO Type                        |
| :--------- | :----------------------------- |
| Prompt     | <span class="text">text</span> |
